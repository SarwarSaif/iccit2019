...
def segmentation_with_NN(filename_tractogram, filename_example_tract,tractList):
    ...
    DM = bundles_distances_mam_smarter_faster(tract , tractogram)
    minVal = find_min_distance(tract, DM)
